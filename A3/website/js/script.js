...
function zoomTestimonial(element) {
    if (element.classList.contains('zoomed')) {
        element.classList.remove('zoomed');
    } else {
        // Remove zoom from all testimonials
        document.querySelectorAll('.testimonial-content').forEach(test => test.classList.remove('zoomed'));
        // Add zoom to clicked testimonial
